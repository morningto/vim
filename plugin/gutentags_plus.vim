...
function! s:GscopeFind(bang, what, ...)
	...
	echom "[cscope ".a:what.": ".l:text."]"
	silent cexpr "[cscope ".a:what.": ".l:text."]"
	let success = 1
	try
		echom 'cs find '.a:what.' '.fnameescape(keyword)
...
command! -nargs=+ -bang GscopeFind call s:GscopeFind(<bang>1, <f-args>)
...
if get(g:, 'gutentags_plus_nomap', 0) == 0
	nnoremap <silent> fs :GscopeFind s <C-R><C-W><cr>
	nnoremap <silent> fg :GscopeFind g <C-R><C-W><cr>
	nnoremap <silent> fc :GscopeFind c <C-R><C-W><cr>
	nnoremap <silent> ft :GscopeFind t <C-R><C-W><cr>
	nnoremap <silent> fe :GscopeFind e <C-R><C-W><cr>
	nnoremap <silent> ff :GscopeFind f <C-R>=expand("<cfile>")<cr><cr>
	nnoremap <silent> fi :GscopeFind i <C-R>=expand("<cfile>")<cr><cr>
	nnoremap <silent> fd :GscopeFind d <C-R><C-W><cr>
	nnoremap <silent> fa :GscopeFind a <C-R><C-W><cr>
	nnoremap <silent> fk :GscopeKill<cr>
endif
